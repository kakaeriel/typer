...
var ButtonView = Backbone.View.extend({
    initialize: function() {
        var self = this;
        var button_start = $('<button>').addClass('btn btn-primary').
                css({
                    float: 'left',
                    'border-radius': '4px',
                    'margin-right': '5px',
                ...
                .click(function() {
                    ...
                    button_resume.prop('disabled', false);
                    $(this).attr('disabled', true);
                });

        var button_stop = $('<button>').addClass('btn btn-danger')
                .attr({
                    disabled: 'disabled'
                })
                .css({
        ...
        var button_pause = $('<button>').addClass('btn btn-success')
                .attr({
                    disabled: 'disabled'
                })
                .css({
        ...
        var button_resume = $('<button>').addClass('btn btn-success')
                .attr({
                    disabled: 'disabled'
                })
                .css({
